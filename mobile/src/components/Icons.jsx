...
export const CheckCircleIcon = ({ className = 'w-5 h-5', filled = false }) => (
...
export const BellOffIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L3 21m18-3l-3.636-3.636M10 5.34A6 6 0 0118.66 14M6 18h11" />
  </svg>
);
...
export const ChatIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M21 12a8.5 8.5 0 01-8.5 8.5c-1.6 0-3.1-.43-4.42-1.18L3 20l.74-5.06A8.5 8.5 0 1121 12z" />
  </svg>
);
...
export const HeadsetIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12a9 9 0 0118 0m-16 0v5a3 3 0 003 3h1v-8H5a2 2 0 01-2-0h0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19 12v5a3 3 0 01-3 3h-1m-8-2h6m6-9a2 2 0 012 2v1a2 2 0 01-2 2h-1v-5h1z" />
  </svg>
);
...
export const SendIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.27 4.45a.75.75 0 011.2-.82l16.5 11.55a.75.75 0 010 1.24L4.47 20.47a.75.75 0 01-1.2-.82L6 12zm0 0h15" />
  </svg>
);
...
export const CreditCardIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2 10h20M2 6a2 2 0 012-2h16a2 2 0 012 2v12a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 14h.01M10 14h.01" />
  </svg>
);
