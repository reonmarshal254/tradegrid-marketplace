...
import { isNavHidden } from './MobileNav';
...
export default function LiveSupportWidget() {
  ...
  const raised = !isNavHidden(location.pathname);
  ...
  return (
    <div
      className={`fixed right-5 z-50 flex flex-col items-end ${
        raised ? 'bottom-[calc(env(safe-area-inset-bottom)+5.5rem)]' : 'bottom-5'
      }`}
    >
      {open && (
